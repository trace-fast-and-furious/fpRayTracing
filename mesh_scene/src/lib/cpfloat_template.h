...
static inline int ADDSUFFIXTO(cpfloat)(FPTYPE *X,
                                       const FPTYPE *A,
                                       const size_t numelem,
                                       optstruct *fpopts)
{
 ...
 */
#ifdef _OPENMP
static inline int CONCATENATE(ADDSUFFIXTO(cpfloat), _sequential)(FPTYPE *X,
                                                                 const FPTYPE *A,
                                                                 const size_t numelem,
                                                                 optstruct *fpopts)
{
...
static inline int CONCATENATE(ADDSUFFIXTO(cpfloat), _parallel)(FPTYPE *X,
                                                               const FPTYPE *A,
                                                               const size_t numelem,
                                                               optstruct *fpopts)
{
